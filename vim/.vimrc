...
" vim颜色主题，当前为Tomorrow-Night-Bright
...
"""""""""""""""""""""""""KEY MAPPING""""""""""""""""""""
inoremap <buffer> <tab> <c-r>=LeaTab()<cr>
inoremap <buffer> ( ()<LEFT>
inoremap <buffer> ) )<c-o>%<c-o>:sleep 500m<CR><c-o>%<c-o>a
inoremap <buffer> ' ''<LEFT>
inoremap <buffer> " ""<LEFT>
inoremap <buffer> [ []<LEFT>
inoremap <buffer> { {}<LEFT>
